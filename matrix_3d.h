...
vec3d translate_3d(double x_base,double y_base, double z_base, double x_translate, double y_translate, double z_translate){
...
vec3d scale_3d(double x_base,double y_base, double z_base, double scale_x, double scale_y, double scale_z){
...
vec3d rotate_3d(double x_to_rotate,double y_to_rotate, double z_to_rotate, double rotate_degrees_x, double rotate_degrees_y, double rotate_degrees_z){
...
vec3d mirror_3d(double x_to_mirror,double y_to_mirror, double z_to_mirror, bool xy_plane, bool yz_plane, bool xz_plane){
...
vec3d shearing_3d(double x_base,double y_base, double z_base, double shearing_x, double shearing_y, double shearing_z, bool shearing_x_axis, bool shearing_y_axis, bool shearing_z_axis){
